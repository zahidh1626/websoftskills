...
const CodeExample = ({ categories, posts }: any) => {
...
//       paths: [{ params: { slug: "javascript-overview-websoftskills" } }],
...
export async function getStaticProps() {
    ...
    const posts = await axios.get("https://websoftskills.com/wp-json/wp/v2/posts");
